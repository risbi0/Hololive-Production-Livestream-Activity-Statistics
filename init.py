        ...
        menu_items={
            'About': '''
                ...
                *(better user experience in desktop)*
                ...
                Based on YouTube livestreams up to **August 3, 2025**, queried using [Holodex API](https://docs.holodex.net/). This doesn't update live; I update this manually twice a month, but I wait a few weeks longer for new generations to have streams in each day.
